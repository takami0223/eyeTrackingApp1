...
namespace eyeTrackingApp1
{
    public partial class Form3_2 : Form
    {
        ...
        private void Form3_2_Load(object sender, EventArgs e)
        {
            ...
            /*-----------------------------------------*/
            List<UserControl2.Image_Proportion> image_proportion1 = UserControl2.image_proportion_onepiece;
            ...
            /*-----------------------------------------*/
            List<UserControl2.Image_Proportion> image_proportion2 = UserControl2.image_proportion_skirt;
            ...
            /*-----------------------------------------*/
            List<UserControl2.Image_Proportion> image_proportion3 = UserControl2.image_proportion_heal;
            ...
            /*-----------------------------------------*/
            List<UserControl2.Image_Proportion> image_proportion4 = UserControl2.image_proportion_all;
            if (image_proportion4.Count != 0) No_data_label4.Visible = false;
            Control_Generation(image_proportion4, panel4);
        }

        private void Control_Generation(List<UserControl2.Image_Proportion> image_proportion, Panel panel)
        {
        ...
        private void tabControl1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                case 0:
                    this.Text = "あなたの記録(ワンピースのみ)";
                    panel1.AutoScrollPosition = new Point(0, 0);
                    break;

                case 1:
                    this.Text = "あなたの記録(スカートのみ)";
                    panel2.AutoScrollPosition = new Point(0, 0);
                    break;

                case 2:
                    this.Text = "あなたの記録(ヒールのみ)";
